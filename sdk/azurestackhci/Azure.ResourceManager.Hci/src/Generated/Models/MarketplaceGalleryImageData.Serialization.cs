...
{
    public partial class MarketplaceGalleryImageData : IUtf8JsonSerializable
    {
        ...
        internal static MarketplaceGalleryImageData DeserializeMarketplaceGalleryImageData(JsonElement element)
        {
            ...
            return new MarketplaceGalleryImageData(id, name, type, systemData.Value, Optional.ToDictionary(tags), location, extendedLocation.Value, containerId.Value, Optional.ToNullable(osType), Optional.ToNullable(cloudInitDataSource), Optional.ToNullable(hyperVGeneration), identifier.Value, version.Value, Optional.ToNullable(provisioningState), status.Value);
        }
    }
}
